    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Level3.this, GameActivity.class);
        ...
        buttonBack.setBackgroundResource(R.drawable.button_stroke_black_opacity_press_white);
        buttonBack.setTextColor(R.color.black_middle);
